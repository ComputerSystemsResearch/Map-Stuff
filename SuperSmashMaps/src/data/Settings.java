...
public class Settings {
	...
	public Settings()
	{
		this.settingsBG = new ImageIcon(getClass().getClassLoader().getResource("res/settingsMenu.png")).getImage();
		this.back = new ImageIcon(getClass().getClassLoader().getResource("res/back.png")).getImage();
		this.check = new ImageIcon(getClass().getClassLoader().getResource("res/check.png")).getImage();
