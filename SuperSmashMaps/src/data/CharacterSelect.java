...
public class CharacterSelect {
	...
	public CharacterSelect(){
		this.selectBG = new ImageIcon(getClass().getClassLoader().getResource("res/CharacterSelectTemp.jpg")).getImage();
		this.back = new ImageIcon(getClass().getClassLoader().getResource("res/back.png")).getImage();
		this.playGame = new ImageIcon(getClass().getClassLoader().getResource("res/PlayGame.png")).getImage();
		this.charSel = new UI();
